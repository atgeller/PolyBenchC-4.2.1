(module
  ...
  (type (;20;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 13520000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13520000)) (i32 33554432)))
  ...
  (type (;21;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13520000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 1300))))))
  (type (;22;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 13520000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13520000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 1300)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 1300))))
                     (post
  ...
  (type (;24;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13520000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 1299)))
  ...
  (type (;25;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 2) (i32 1299)))
                      (eq (i32 1) (i32.gt_u (local 2) (i32 0)))
                      (eq (local 7) (i32.sub (local 2) (i32 1)))
                      (eq (local 6) (i32.add (local 2) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 1299)))
  ...
  (func $kernel_jacobi_2d (type 6) (param i32 i32)
