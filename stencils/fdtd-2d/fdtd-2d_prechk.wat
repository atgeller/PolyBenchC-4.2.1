(module
  ...
  (type (;20;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 9600000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 9600000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 9600000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 4000)) (i32 67108864)))
  ...
  (type (;21;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 4000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 500))))
                     (post
  ...
  (type (;22;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 9600000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 1000))))))
  (type (;23;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 9600000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 67108864)))
  ...
  (type (;25;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 4000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 10) (i32 500))))))
  (type (;26;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 9600000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 67108864)))
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 4000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 10) (i32 500)))
                      (eq (local 5) (i32.add (local 3) (i32.shl (local 10) (i32 3))))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 1200))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 4000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 10) (i32 500)))
                      (eq (i32 1) (i32.lt_u (local 6) (i32 1000)))
                      (eq (i32 1) (i32.gt_u (local 6) (i32 0))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (type (;28;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 6) (i32 1000)))
                      (eq (i32 1) (i32.gt_u (local 6) (i32 0)))
                      (eq (local 8) (i32.sub (local 6) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 1200))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
  ...
  (type (;31;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 4000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 10) (i32 500)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 999))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (type (;32;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 10) (i32 500)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 999)))
                      (eq (local 11) (i32.add (local 8) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 1199))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    call $dlfree
    i32.const 0)
  (func $init_array (type 7) (param i32 i32 i32 i32)
  ...
  (func $kernel_fdtd_2d (type 7) (param i32 i32 i32 i32)
  ...
  (func $getint (type 0) (param i32) (result i32)
    ...
    local.get 1)
  (func $pop_arg (type 7) (param i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
  ...
  (data (;0;) (i32.const 1024) "hz\00[PolyBench] posix_memalign: cannot allocate memory\00ey\00ex\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00begin dump: %s\00nan\00inf\00NAN\00INF\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\b0\06\00\00\00\00\00\00\19\00\0a\00\19\19\19\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\19\00\11\0a\19\19\19\03\0a\07\00\01\00\09\0b\18\00\00\09\06\0b\00\00\0b\00\06\19\00\00\00\19\19\19")
  (data (;1;) (i32.const 1313) "\0e\00\00\00\00\00\00\00\00\19\00\0a\0d\19\19\19\00\0d\00\00\02\00\09\0e\00\00\00\09\00\0e\00\00\0e")
  (data (;2;) (i32.const 1371) "\0c")
  (data (;3;) (i32.const 1383) "\13\00\00\00\00\13\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data (;4;) (i32.const 1429) "\10")
  (data (;5;) (i32.const 1441) "\0f\00\00\00\04\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10")
  (data (;6;) (i32.const 1487) "\12")
  (data (;7;) (i32.const 1499) "\11\00\00\00\00\11\00\00\00\00\09\12\00\00\00\00\00\12\00\00\12\00\00\1a\00\00\00\1a\1a\1a")
  (data (;8;) (i32.const 1554) "\1a\00\00\00\1a\1a\1a\00\00\00\00\00\00\09")
  (data (;9;) (i32.const 1603) "\14")
  (data (;10;) (i32.const 1615) "\17\00\00\00\00\17\00\00\00\00\09\14\00\00\00\00\00\14\00\00\14")
  (data (;11;) (i32.const 1661) "\16")
  (data (;12;) (i32.const 1673) "\15\00\00\00\00\15\00\00\00\00\09\16\00\00\00\00\00\16\00\00\16\00\000123456789ABCDEF")
  (data (;13;) (i32.const 1712) "\05")
  (data (;14;) (i32.const 1724) "\02")
  (data (;15;) (i32.const 1748) "\03\00\00\00\04\00\00\00\a0\08")
  (data (;16;) (i32.const 1772) "\02")
  (data (;17;) (i32.const 1788) "\ff\ff\ff\ff\ff\ff\ff\ff")
  (data (;18;) (i32.const 1856) "\b0\06\00\00\00\00\00\00\05")
  (data (;19;) (i32.const 1876) "\05")
  (data (;20;) (i32.const 1900) "\03\00\00\00\06\00\00\00\a8\08\00\00\00\04")
  (data (;21;) (i32.const 1924) "\01")
  (data (;22;) (i32.const 1940) "\ff\ff\ff\ff\0a")
  (data (;23;) (i32.const 2008) "H\07\00\00\a0\0eP"))
