(module
  ...
  (type (;24;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 32000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 1999)))
                      (eq (i32 1) (i32.gt_u (local 1) (i32 0))))
                     (post
                      (eq (local 0) (old_local 0)))))
  (type (;25;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      ...
                      (eq (i32 1) (i32.gt_u (local 6) (i32 1)))
                      (eq (local 12) (i32.sub (local 6) (i32 2)))
                      (eq (local 3) (i32.add (local 0) (i32.mul (i32.sub (local 6) (i32 1)) (i32 16000))))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 1999)))
  ...
  (func $kernel_seidel_2d (type 3) (param i32)
    (local i32 i32 i32 f64 i32 i32 f64 f64 f64 f64 f64 i32 f64 f64)
    ;; Hand inserted check that sizes are legal
    block (type 20)
      local.get 0
      i32.const 32000000
