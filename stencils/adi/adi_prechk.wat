(module
  ...
  (type (;20;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 8000000)) (i32 67108864)))
                      (eq (local 1) (old_local 1)))))
  (type (;21;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 8000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 1000))))))
  (type (;22;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 8000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 1000)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 1000))))
                     (post
  ...
  (type (;23;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 8000000)) (i32 67108864)))
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 8000000)) (i32 67108864)))
                      (eq (local 1) (old_local 1)))))
  (type (;24;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 8000000)) (i32 67108864)))
  ...
  (type (;25;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 8000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 999)))
                      (eq (i32 1) (i32.gt_u (local 5) (i32 0))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
  ...
  (type (;26;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 8000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 9) (i32 1000)))
                      (eq (i32 1) (i32.gt_u (local 9) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 999)))
                      (eq (i32 1) (i32.gt_u (local 4) (i32 0)))
                      (eq (i32 1) (i32.le_u (local 7) (i32.add (i32 7992000) (local 2))))
                      (eq (i32 1) (i32.le_u (local 8) (i32.add (i32 7992000) (local 3))))
                      (eq (i32 1) (i32.le_u (local 11) (i32 7992)))
                      (eq (local 13) (i32.sub (local 9) (i32 2))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (type (;29;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 8000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 13) (i32 1000)))
                      (eq (i32 1) (i32.gt_u (local 13) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 999)))
                      (eq (i32 1) (i32.gt_u (local 5) (i32 0)))
                      (eq (i32 1) (i32.lt_u (local 10) (i32 7992000)))
                      (eq (i32 1) (i32.le_u (local 9) (i32.add (local 10) (local 0))))
                      (eq (i32 1) (i32.le_u (local 7) (i32.add (local 10) (local 2))))
                      (eq (i32 1) (i32.le_u (local 8) (i32.add (local 10) (local 3))))
                      (eq (local 12) (i32.sub (local 13) (i32 2))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (type (;30;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 999)))
                      (eq (i32 1) (i32.gt_u (local 4) (i32 0)))
                      (eq (i32 1) (i32.le_u (local 9) (i32.add (i32 7992000) (local 0))))
                      (eq (i32 1) (i32.le_u (local 7) (i32.add (i32 7992000) (local 2))))
                      (eq (i32 1) (i32.le_u (local 8) (i32.add (i32 7992000) (local 3)))))
                     (post
                      (eq (local 0) (old_local 0))
  ...
  (func $kernel_adi (type 9) (param i32 i32 i32 i32)
    (local i32 i32 f64 i32 i32 i32 i32 i32 i32 i32 i32)
    ;; Hand inserted check that sizes are legal
    block (type 23)
      local.get 0
      i32.const 8000000
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00u\00begin dump: %s\00nan\00inf\00NAN\00INF\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00\b0\06")
