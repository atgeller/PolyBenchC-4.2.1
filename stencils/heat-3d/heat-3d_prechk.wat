(module
  ...
  (type (;20;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 13824000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13824000)) (i32 67108864)))
  ...
  (type (;21;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13824000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 120))))))
  (type (;22;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 13824000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13824000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 120)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 120))))
                     (post
  ...
  (type (;23;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 2) (i32 120)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 120)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 120))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (type (;25;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 13824000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 119)))
                      (eq (i32 1) (i32.gt_u (local 3) (i32 0))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1)))))
  (type (;26;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 3) (i32 119)))
                      (eq (i32 1) (i32.gt_u (local 3) (i32 0)))
                      (eq (local 9) (i32.add (local 3) (i32 1)))
                      (eq (local 11) (i32.sub (local 3) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 119)))
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 119)))
                      (eq (i32 1) (i32.gt_u (local 4) (i32 0)))
                      (eq (local 10) (i32.add (local 4) (i32 1)))
                      (eq (local 12) (i32.sub (local 4) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 119)))
  ...
  (func $kernel_heat_3d (type 6) (param i32 i32)
