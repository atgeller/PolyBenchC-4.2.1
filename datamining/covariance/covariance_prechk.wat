(module
  ...
  (type (;12;) (func (param f64 i32 i32 i32)))
  ...
  (type (;26;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 9600)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 1200)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 1400)))
                      (eq (local 7) (i32.shl (local 4) (i32 3)))
                      (eq (local 8) (i32.add (local 7) (local 3))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 9600)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 1400))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3)))))
  ...
  (type (;31;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 1200)))
                      (eq (i32 1) (i32.lt_u (local 9) (i32 1200)))
                      (eq (local 3) (i32.shl (local 9) (i32 3)))
                      (eq (local 7) (i32.add (local 2) (i32.add (local 3) (i32.mul (local 4) (i32 9600)))))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 1400))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
                      ...
                      (eq (local 10) (i32.shl (local 4) (i32 3))))))
  ...
  (func $kernel_covariance (type 12) (param f64 i32 i32 i32)
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00cov\00begin dump: %s\00nan\00inf\00NAN\00INF\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\b0\06")
