(module
  ...
  (type (;14;) (func (param f32 i32 i32 i32 i32)))
  (type (;15;) (func (param i32 f32) (result f32)))
  ...
  (type (;25;) (func (post
                      (eq (i32 1) (i32.lt_u (local 1) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 35389440)) (i32 274989056)))
                      (eq (local 2) (old_local 2)))))
  (type (;26;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 1) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 4096))))))
  (type (;27;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 1) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 4096)))
                      (eq (i32 1) (i32.lt_u (local 0) (i32 2160))))
                     (post
  ...
  (type (;28;) (func (post
                      (eq (i32 1) (i32.lt_u (local 1) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
  ...
  (type (;29;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 13) (i32 4096))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (type (;30;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 13) (i32 4096)))
                      (eq (i32 1) (i32.lt_u (local 6) (i32 2160))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
  ...
  (type (;31;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 13) (i32 4096)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 2160))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
  ...
  (type (;32;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 7) (i32 4096))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4)))))
  ...
  (type (;34;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 7) (i32 2160))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4)))))
  (type (;35;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 7) (i32 2160)))
                      (eq (i32 1) (i32.lt_u (local 6) (i32 4096))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
  ...
  (type (;36;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 35389440)) (i32 274989056)))
                      (eq (i32 1) (i32.lt_u (local 7) (i32 2160)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 4096))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
  ...
  (func $kernel_deriche (type 14) (param f32 i32 i32 i32 i32)
    (local i32 i32 i32 f32 f32 f32 f32 f32 i32 f32 f32 f32 f32 f32)
    ;; Hand inserted check that sizes are legal
    block (type 28)
      local.get 1
      i32.const 35389440
  ...
  (func $emscripten_get_heap_size (type 4) (result i32)
    ...
    i32.const 16
    i32.shl)
  (func $__math_xflowf (type 15) (param i32 f32) (result f32)
    local.get 1
    f32.neg
    local.get 1
    local.get 0
    ...
    local.get 1
    f32.mul)
  (func $fp_barrierf (type 9) (param f32) (result f32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    local.get 1
    f32.load offset=12)
  (func $__math_oflowf (type 11) (param i32) (result f32)
    local.get 0
    f32.const 0x1p+97 (;=1.58456e+29;)
    call $__math_xflowf)
  (func $__math_uflowf (type 11) (param i32) (result f32)
    local.get 0
    f32.const 0x1p-95 (;=2.52435e-29;)
    call $__math_xflowf)
  (func $exp2f (type 9) (param f32) (result f32)
    (local f64 i32 i32 f64 f64 i64)
  ...
  (func $expf (type 9) (param f32) (result f32)
    ...
    block (result f32)  ;; label = @1
      block  ;; label = @2
        ...
        local.get 0
        f32.const 0x1.62e42ep+6 (;=88.7228;)
        f32.gt
        if  ;; label = @3
          i32.const 0
          call $__math_oflowf
        ...
        local.get 0
        f32.const -0x1.9fe368p+6 (;=-103.972;)
        f32.lt
        i32.eqz
        br_if 0 (;@2;)
        i32.const 0
  ...
  (func $top12 (type 16) (param f32) (result i32)
    local.get 0
    i32.reinterpret_f32
    i32.const 20
    i32.shr_u)
  ...
  (func $frexp (type 17) (param f64 i32) (result f64)
    ...
    local.get 0)
  (func $__vfprintf_internal (type 18) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    global.get 0
    i32.const 208
    i32.sub
    ...
    global.set 0
    local.get 1)
  (func $printf_core (type 19) (param i32 i32 i32 i32 i32 i32 i32) (result i32)
    ...
    global.set 0
    local.get 14)
  (func $out (type 20) (param i32 i32 i32)
    local.get 0
    i32.load8_u
    i32.const 32
    i32.and
  ...
  (func $getint (type 0) (param i32) (result i32)
    ...
    local.get 1)
  (func $pop_arg (type 21) (param i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
    ...
    i64.load
    i64.store)
  (func $fmt_x (type 22) (param i64 i32 i32) (result i32)
    (local i32)
    local.get 0
    i64.eqz
    i32.eqz
  ...
  (func $pad (type 23) (param i32 i32 i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func $fmt_fp (type 12) (param i32 f64 i32 i32 i32 i32) (result i32)
    ...
    global.set 0
    local.get 9)
  (func $__DOUBLE_BITS (type 24) (param f64) (result i64)
    local.get 0
    i64.reinterpret_f64)
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00imgOut\00begin dump: %s\00nan\00inf\00NAN\00INF\00.\00(null)\00%0.2f \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a")
  (data (;1;) (i32.const 1230) "\f0?t\85\15\d3\b0\d9\ef?\0f\89\f9lX\b5\ef?Q[\12\d0\01\93\ef?{Q}<\b8r\ef?\aa\b9h1\87T\ef?8bunz8\ef?\e1\de\1f\f5\9d\1e\ef?\15\b71\0a\fe\06\ef?\cb\a9:7\a7\f1\ee?\224\12L\a6\de\ee?-\89a`\08\ce\ee?'*6\d5\da\bf\ee?\82O\9dV+\b4\ee?)TH\dd\07\ab\ee?\85U:\b0~\a4\ee?\cd;\7ff\9e\a0\ee?t_\ec\e8u\9f\ee?\87\01\ebs\14\a1\ee?\13\ceL\99\89\a5\ee?\db\a0*B\e5\ac\ee?\e5\c5\cd\b07\b7\ee?\90\f0\a3\82\91\c4\ee?]%>\b2\03\d5\ee?\ad\d3Z\99\9f\e8\ee?G^\fb\f2v\ff\ee?\9cR\85\dd\9b\19\ef?i\90\ef\dc 7\ef?\87\a4\fb\dc\18X\ef?_\9b{3\97|\ef?\da\90\a4\a2\af\a4\ef?@En[v\d0\ef?\00\00\00\00\00\00\e8B\94#\91K\f8j\ac?\f3\c4\faP\ce\bf\ce?\d6R\0c\ffB.\e6?\00\00\00\00\00\008C\fe\82+eG\15G@\94#\91K\f8j\bc>\f3\c4\faP\ce\bf.?\d6R\0c\ffB.\96?\00\08")
  (data (;2;) (i32.const 1568) "\19\00\0a\00\19\19\19\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\19\00\11\0a\19\19\19\03\0a\07\00\01\00\09\0b\18\00\00\09\06\0b\00\00\0b\00\06\19\00\00\00\19\19\19")
  (data (;3;) (i32.const 1649) "\0e\00\00\00\00\00\00\00\00\19\00\0a\0d\19\19\19\00\0d\00\00\02\00\09\0e\00\00\00\09\00\0e\00\00\0e")
  (data (;4;) (i32.const 1707) "\0c")
  (data (;5;) (i32.const 1719) "\13\00\00\00\00\13\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data (;6;) (i32.const 1765) "\10")
  (data (;7;) (i32.const 1777) "\0f\00\00\00\04\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10")
  (data (;8;) (i32.const 1823) "\12")
  (data (;9;) (i32.const 1835) "\11\00\00\00\00\11\00\00\00\00\09\12\00\00\00\00\00\12\00\00\12\00\00\1a\00\00\00\1a\1a\1a")
  (data (;10;) (i32.const 1890) "\1a\00\00\00\1a\1a\1a\00\00\00\00\00\00\09")
  (data (;11;) (i32.const 1939) "\14")
  (data (;12;) (i32.const 1951) "\17\00\00\00\00\17\00\00\00\00\09\14\00\00\00\00\00\14\00\00\14")
  (data (;13;) (i32.const 1997) "\16")
  (data (;14;) (i32.const 2009) "\15\00\00\00\00\15\00\00\00\00\09\16\00\00\00\00\00\16\00\00\16\00\000123456789ABCDEF")
  (data (;15;) (i32.const 2048) "\05")
  (data (;16;) (i32.const 2060) "\02")
  (data (;17;) (i32.const 2084) "\03\00\00\00\04\00\00\00\f0\09")
  (data (;18;) (i32.const 2108) "\02")
  (data (;19;) (i32.const 2124) "\ff\ff\ff\ff\ff\ff\ff\ff")
  (data (;20;) (i32.const 2193) "\08\00\00\00\00\00\00\05")
  (data (;21;) (i32.const 2212) "\05")
  (data (;22;) (i32.const 2236) "\03\00\00\00\06\00\00\00\f8\09\00\00\00\04")
  (data (;23;) (i32.const 2260) "\01")
  (data (;24;) (i32.const 2276) "\ff\ff\ff\ff\0a")
  (data (;25;) (i32.const 2344) "\98\08\00\00\f0\0fP"))
