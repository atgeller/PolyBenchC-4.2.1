(module
  ...
  (type (;18;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 31360000)) (i32 33554432)))
                      (eq (local 1) (old_local 1)))))
  (type (;19;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 31360000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2800))))))
  (type (;20;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 31360000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2800)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 2800))))
                     (post
  ...
  (type (;21;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2800)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 2800)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 2800)))
                      (eq (local 6) (i32.add (local 0) (i32.mul (local 2) (i32 11200))))
                      (eq (local 7) (i32.add (local 6) (i32.shl (local 1) (i32 2)))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
  ...
  (func $kernel_floyd_warshall (type 3) (param i32)
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00begin dump: %s\00path\00(null)\00%d \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\80\06\00\00\19\00\0a\00\19\19\19\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\19\00\11\0a\19\19\19\03\0a\07\00\01\00\09\0b\18\00\00\09\06\0b\00\00\0b\00\06\19\00\00\00\19\19\19")
