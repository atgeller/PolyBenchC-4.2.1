(module
  ...
  (type (;13;) (func (param f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i32)))
  ...
  (type (;22;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 32000000)) (i32 67108864)))
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 5) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 6) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 6) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 7) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 7) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 8) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 9) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 9) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 10) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 10) (i32 16000)) (i32 67108864)))
  ...
  (type (;23;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 10) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 10) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 12) (i32 2000))))))
  (type (;24;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 32000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      ...
                      (eq (i32 1) (i32.lt_u (local 10) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 10) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 0) (i32 2000)))
                      (eq (local 12) (i32.add (local 0) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2000))))
                     (post
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 10) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 12) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 11) (i32 2000)))
                      (eq (local 16) (i32.add (local 5) (i32.shl (local 12) (i32 3))))
                      (eq (local 17) (i32.add (local 3) (i32.shl (local 12) (i32 3)))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
  ...
  (type (;29;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 12) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 11) (i32 2000)))
                      (eq (local 14) (i32.shl (local 12) (i32 3)))
                      (eq (local 13) (i32.add (local 8) (local 14))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
  ...
  (type (;31;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 10) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 10) (i32 16000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 13) (i32 2000))))))
  (type (;32;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 32000000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      ...
                      (eq (i32 1) (i32.lt_u (local 13) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 11) (i32 2000)))
                      (eq (local 12) (i32.add (local 7) (i32.shl (local 13) (i32 3)))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    global.set 0
    i32.const 0)
  (func $init_array (type 12) (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    (local f64 i32)
  ...
  (func $kernel_gemver (type 13) (param f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i32)
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00w\00begin dump: %s\00nan\00inf\00NAN\00INF\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00\b0\06")
