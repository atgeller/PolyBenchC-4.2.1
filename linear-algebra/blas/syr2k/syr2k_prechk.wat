(module
  ...
  (type (;21;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 8000000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 9600000)) (i32 33554432)))
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (local 8) (i32.add (local 7) (i32 1))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4)))))
  (type (;28;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 7) (i32 1200)))
                      (eq (local 8) (i32.add (local 7) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 5) (local 8))))
                     (post
                      (eq (local 7) (old_local 7))
  ...
  (type (;30;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 5) (local 8)))
                      (eq (local 11) (i32.add (local 2) (i32.mul (local 7) (i32 9600))))
                      (eq (local 6) (i32.shl (local 9) (i32 3)))
                      (eq (local 12) (i32.add (i32.add (local 3) (local 6)) (i32.mul (local 7) (i32 8000))))
                      (eq (local 13) (i32.add (i32.add (local 4) (local 6)) (i32.mul (local 7) (i32 8000)))))
                     (post
  ...
  (func $kernel_syr2k (type 13) (param f64 f64 i32 i32 i32)
