(module
  ...
  (type (;13;) (func (param f64 f64 i32 i32 i32)))
  ...
  (type (;21;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 8000000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 9600000)) (i32 33554432)))
  ...
  (type (;22;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 9600000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 0) (i32 1000))))
                     (post
  ...
  (type (;24;) (func (pre
                      ...
                      (eq (local 6) (i32.add (i32 1) (local 5))))))
  (type (;25;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 2) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 9600000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 33554432)))
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 9600000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 0) (i32 1000)))
                      (eq (i32 1) (i32.lt_u (local 1) (local 6)))
                      (eq (local 0) (local 5))
                      (eq (local 6) (i32.add (i32 1) (local 0))))
                     (post
                      (eq (local 0) (old_local 0))
                      ...
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
                      (eq (i32 1) (i32.le_u (local 7) (i32.add (local 3) (i32 7992000))))))) ;; 7992000 = l0 * 8000
  (type (;26;) (func (post
                      (eq (local 5) (old_local 5))
                      (eq (local 6) (old_local 6))
                      (eq (local 2) (old_local 2))
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (i32 1) (i32.le_u (local 7) (i32.add (local 3) (i32 7992000))))
                      (eq (local 6) (local 5)))
                     (post
                      (eq (local 5) (old_local 5))
                      (eq (local 6) (old_local 6))
  ...
  (type (;29;) (func (pre
                      ...
                      (eq (local 11) (i32.add (local 3) (i32.mul (local 5) (i32 8000))))
                      (eq (local 12) (i32.add (local 11) (i32.shl (local 5) (i32 3)))))
                     (post
                      (eq (local 5) (old_local 5))
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
  ...
  (type (;31;) (func (pre
                      ...
                      (eq (local 13) (i32.mul (local 5) (i32 9600)))
                      (eq (local 10) (i32.add (local 4) (i32.add (local 13) (local 8)))))
                     (post
                      (eq (local 13) (old_local 13))
                      (eq (local 12) (old_local 12))
                      (eq (local 11) (old_local 11))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    global.set 0
    i32.const 0)
  (func $init_array (type 9) (param i32 i32 i32 i32 i32)
    (local i32 i32 i32)
  ...
  (func $kernel_symm (type 13) (param f64 f64 i32 i32 i32)
    (local i32 i32 i32 i32 f64 i32 i32 i32 i32 i32 i32 i32)
    ;; Hand inserted check that sizes are legal
    block (type 21)
      local.get 2
      i32.const 9600000
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00begin dump: %s\00nan\00inf\00NAN\00INF\00C\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00\b0\06")
