(module
  ...
  (type (;13;) (func (param f64 f64 i32 i32)))
  ...
  (type (;21;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 11520000)) (i32 33554432)))
  ...
  (type (;26;) (func (pre
                      ...
                      (eq (local 6) (i32.add (local 5) (i32 1))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3)))))
  (type (;27;) (func (pre
                     ...
                     (post
                      (eq (local 9) (i32.add (local 2) (i32.mul (local 5) (i32 9600))))
                      (eq (local 8) (i32 0))
                      (eq (local 5) (old_local 5))
  ...
  (type (;29;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 8) (i32 1000)))
                      (eq (i32 1) (i32.lt_u (local 4) (local 6)))
                      (eq (local 10) (i32.shl (local 8) (i32 3)))
                      (eq (local 11) (i32.add (local 3) (i32.add (local 10) (i32.mul (local 5) (i32 8000)))))
                      (eq (local 9) (i32.add (local 2) (i32.mul (local 5) (i32 9600)))))
                     (post
  ...
  (func $kernel_syrk (type 13) (param f64 f64 i32 i32)
