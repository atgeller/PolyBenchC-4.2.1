(module
  ...
  (type (;21;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 8000000)) (i32 134217728)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 134217728)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 9600000)) (i32 134217728)))
  ...
  (type (;24;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 9600000)) (i32 134217728)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 1000)))
                      (eq (i32 1) (i32.lt_u (local 0) (local 3))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3)))))
  ...
  (type (;29;) (func (pre
                      ...
                      (eq (local 8) (i32.shl (local 5) (i32 3)))
                      (eq (local 7) (i32.add (i32.add (local 2) (i32.mul (local 3) (i32 9600))) (local 8))))
                     (post
                      (eq (local 8) (old_local 8))
                      (eq (local 7) (old_local 7))
                      (eq (local 5) (old_local 5))
