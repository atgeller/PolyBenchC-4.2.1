(module
  ...
  (type (;13;) (func (param f64 f64 i32 i32 i32 i32 i32)))
  ...
  ;; 15200 = 1100*8+800*8 = max i*8+j*8, etc...
  ;; 67108864 = 65536*256-8 = max memory index
  (type (;22;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 800)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 7040000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 7920000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 8640000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 5) (i32 7680000)) (i32 67108864))))
                     (post
  ...
  (type (;24;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 1100)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 7040000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 7920000)) (i32 67108864)))
  ...
  (type (;25;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 1100)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 900)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 7040000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 7920000)) (i32 67108864)))
                     ...
                     (post
                      ...
                      (eq (local 0) (old_local 0)))))
  (type (;26;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 900)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 7040000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 7920000)) (i32 67108864)))
  ...
  (type (;27;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 900)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 1200)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 7040000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 7920000)) (i32 67108864)))
  ...
  (type (;31;) (func (post
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 5760000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 7040000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 7920000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 5) (i32 8640000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 6) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 6) (i32 7680000)) (i32 67108864)))
  ...
  (type (;32;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 6) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 6) (i32 7680000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 800))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 5) (old_local 5))
  ...
  (type (;33;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 6) (i32 7680000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 800)))
                      (eq (i32 1) (i32.lt_u (local 11) (i32 900))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
  ...
  (type (;34;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 8) (i32 800)))
                      (eq (i32 1) (i32.lt_u (local 11) (i32 900)))
                      (eq (i32 1) (i32.lt_u (local 7) (i32 1100)))
                      (eq (i32 1) (i32.le_u (local 12) (i32.add (local 2) (i32 5759992))))
                      (eq (i32 1) (i32.le_u (local 9) (i32 7192))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 3) (old_local 3))
                      (eq (local 4) (old_local 4))
  ...
  (type (;35;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 6) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 6) (i32 7680000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 9) (i32 800))))))
  (type (;36;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 2) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 5760000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 67108864)))
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 6) (i32 7680000)) (i32 67108864)))
                      (eq (i32 1) (i32.lt_u (local 9) (i32 800)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 1200))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 5) (old_local 5))
                      (eq (local 6) (old_local 6))
  ...
  (type (;37;) (func (pre
                      ...
                      (eq (i32 1) (i32.le_u (local 8) (i32.add (local 6) (i32 7679992))))
                      (eq (i32 1) (i32.le_u (local 12) (i32 9592))))
                     (post
                      (eq (local 2) (old_local 2))
                      (eq (local 5) (old_local 5))
                      (eq (local 6) (old_local 6))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    global.set 0
    i32.const 0)
  (func $init_array (type 12) (param i32 i32 i32 i32 i32 i32)
  ...
  (func $kernel_2mm (type 13) (param f64 f64 i32 i32 i32 i32 i32)
  ...
  (func $xmalloc (type 0) (param i32) (result i32)
    ...
    global.get 0
    i32.const 16
    i32.sub                          ;; global stack bs
    local.tee 1
    global.set 0
    local.get 1
    i32.const 0
    i32.store offset=12              ;; store 0
    local.get 1
    i32.const 12
    i32.add                          ;; global bs + 12 - 16
    i32.const 4096                   ;; 4096
    local.get 0                      ;; size
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00begin dump: %s\00nan\00inf\00NAN\00INF\00D\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00\b0\06")
