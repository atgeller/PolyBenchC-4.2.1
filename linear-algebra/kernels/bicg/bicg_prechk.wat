(module
  ...
  (type (;20;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 31920000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 16800)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 15200)) (i32 33554432)))
  ...
  (type (;21;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 2) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 15200)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 1900))))
                     (post
  ...
  (type (;22;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 2) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 15200)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 2100))))))
  (type (;23;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 31920000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
  ...
  (type (;24;) (func (post
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 31920000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 8) (i32 15200)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 16800)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 15200)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 16800)) (i32 33554432)))
  ...
  (type (;25;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 16800)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 2100))))))
  (type (;26;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 31920000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 33554432)))
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 16800)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 2100)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 1900)))
                      (eq (local 6) (i32.add (local 2) (i32.shl (local 5) (i32 3))))
                      (eq (local 9) (i32.add (local 4) (i32.shl (local 5) (i32 3)))))
                     (post
                      (eq (local 0) (old_local 0))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    call $dlfree
    i32.const 0)
  (func $init_array (type 10) (param i32 i32 i32)
    (local i32 i32)
    unreachable
    ;; l0 + 31920000 < memory
    ;; l1 + 16800 < memory
  ...
  (func $kernel_bicg (type 11) (param i32 i32 i32 i32 i32)
  ...
  (func $print_array (type 7) (param i32 i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 96
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00begin dump: %s\00q\00nan\00inf\00NAN\00INF\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00\b0\06")
