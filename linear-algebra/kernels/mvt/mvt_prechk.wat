(module
  ...
  (type (;20;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 16000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 16000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 16000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 3) (i32 16000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 4) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 32000000)) (i32 33554432)))
  ...
  (type (;21;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 4) (i32 32000000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 7) (i32 2000))))))
  (type (;22;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 16000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 33554432)))
  ...
  (type (;25;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 6) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 2000)))
                      (eq (local 7) (i32.add (local 0) (i32.shl (local 6) (i32 3)))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 7) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 2000)))
                      (eq (local 9) (i32.shl (local 7) (i32 3)))
                      (eq (local 6) (i32.add (local 1) (local 9))))
                     (post
                      (eq (local 0) (old_local 0))
                      (eq (local 1) (old_local 1))
                      (eq (local 2) (old_local 2))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    call $dlfree
    i32.const 0)
  (func $init_array (type 7) (param i32 i32 i32 i32 i32)
    (local i32 i32 i32)
    ;; l0..l3 + 2000*8 < memory
    ;; l4 + 2000*2000*8 < memory
  ...
  (func $kernel_mvt (type 7) (param i32 i32 i32 i32 i32)
  ...
  (func $fmt_u (type 9) (param i64 i32) (result i32)
    ...
    local.get 1)
  (func $pad (type 7) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 256
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00begin dump: %s\00nan\00inf\00NAN\00INF\00x2\00x1\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00\b0\06\00\00\00\00\00\00\19\00\0a\00\19\19\19\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\19\00\11\0a\19\19\19\03\0a\07\00\01\00\09\0b\18\00\00\09\06\0b\00\00\0b\00\06\19\00\00\00\19\19\19")
