(module
  ...
  (type (;33;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 32000000)) (i32 134217728)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 3) (local 1))))
                     (post
                      (eq (local 1) (old_local 1))
                      (eq (local 0) (old_local 0)))))
  (type (;34;) (func (post
  ...
  (type (;35;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 3) (local 1)))
                      (eq (i32 1) (i32.lt_u (local 2) (local 3)))
                      (eq (local 5) (i32.add (local 0) (i32.mul (local 1) (i32 16000))))
                      (eq (local 6) (i32.shl (local 3) (i32 3)))
                      (eq (local 7) (i32.add (local 5) (local 6))))
                     (post
                      (eq (local 7) (old_local 7))
                      (eq (local 6) (old_local 6))
                      (eq (local 3) (old_local 3))
  ...
  (type (;38;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 2) (local 1)))
                      (eq (local 3) (i32.add (local 0) (i32.mul (local 1) (i32 16000))))
                      (eq (local 6) (i32.shl (local 5) (i32 3)))
                      (eq (local 7) (i32.add (local 3) (local 6))))
                     (post
                      (eq (local 5) (old_local 5))
                      (eq (local 1) (old_local 1))
                      (eq (local 0) (old_local 0)))))
  ...
  (func $init_array (type 3) (param i32)
    ...
    local.get 2
    call $dlfree)
  (func $kernel_lu (type 3) (param i32)
