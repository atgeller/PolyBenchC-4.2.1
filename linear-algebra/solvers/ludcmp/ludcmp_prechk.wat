(module
  ...
  (type (;23;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 4) (local 7))))
                     (post
  ...
  (type (;36;) (func (pre
                      ...
                      (eq (local 9) (i32.add (local 0) (i32.mul (local 5) (i32 16000))))
                      (eq (local 8) (i32.shl (local 6) (i32 3))))
                     (post
                      (eq (local 8) (old_local 8))
                      (eq (local 10) (old_local 10))
                      (eq (local 6) (old_local 6))
  ...
  (type (;39;) (func (pre
                      ...
                      (eq (local 6) (i32.add (local 0) (i32.mul (local 5) (i32 16000))))
                      (eq (local 8) (i32.shl (local 9) (i32 3)))
                      (eq (local 10) (i32.add (local 6) (local 8))))
                     (post
                      (eq (local 10) (old_local 10))
                      (eq (local 9) (old_local 9))
                      (eq (local 5) (old_local 5))
  ...
  (func $init_array (type 7) (param i32 i32 i32 i32)
    ...
    local.get 7
    call $dlfree)
  (func $kernel_ludcmp (type 7) (param i32 i32 i32 i32)
