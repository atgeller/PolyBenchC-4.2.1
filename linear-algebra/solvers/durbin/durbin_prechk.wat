(module
  ...
  (type (;20;) (func (post
                      (eq (i32 1) (i32.lt_u (local 0) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 16000)) (i32 16777216)))
  ...
  (type (;22;) (func (post
                      (eq (i32 1) (i32.lt_u (local 0) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 16000)) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 1) (i32 16000)) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 5) (i32 16000)) (i32 16777216)))
  ...
  (type (;23;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 5) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 5) (i32 16000)) (i32 16777216)))
                      (eq (local 4) (i32.add (local 6) (i32 1)))
                      (eq (i32 1) (i32.gt_u (local 4) (i32 0)))
                      (eq (i32 1) (i32.lt_u (local 6) (i32 1999))))))
  (type (;24;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 16000)) (i32 16777216)))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 16777216)))
  ...
  (func $kernel_durbin (type 7) (param i32 i32)
    (local f64 i32 i32 i32 i32 f64 f64 i32 i32 i32)
    global.get 0
    i32.const 16000
    i32.sub
    local.tee 5
    ...
    loop (type 23) ;; label = @1
      ...
      local.get 5
      local.get 9
      call $__memcpy ;; could reason about the result here to prechk the next store
      local.get 10
      i32.add
      local.get 2
      f64.store
