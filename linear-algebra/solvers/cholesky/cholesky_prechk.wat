(module
  ...
  (type (;20;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 32000000)) (i32 33554432)))
  ...
  (type (;21;) (func (pre
                      ...
                      (eq (local 2) (i32.add (local 1) (i32 1))))
                     (post
  ...
  (type (;22;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 32000000)) (i32 33554432)))
                      (eq (local 2) (i32.add (local 3) (i32 1)))
                      (eq (i32 1) (i32.lt_u (local 1) (local 2)))
                      (eq (i32 1) (i32.lt_u (local 3) (i32 2000))))
                     (post
                      (eq (local 3) (old_local 3))
                      (eq (local 6) (i32.add (local 0) (i32.mul (local 3) (i32 16000))))
  ...
  (type (;24;) (func (post
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 32000000)) (i32 33554432)))
                      (eq (local 0) (old_local 0))
                      (eq (local 8) (old_local 8)))))
  (type (;25;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
  ...
  (type (;27;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 2) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 2) (i32 32000000)) (i32 33554432)))
                      (eq (local 4) (i32.shl (local 8) (i32 3)))
                      (eq (local 6) (i32.mul (local 5) (i32 16000)))
                      (eq (local 7) (i32.add (local 0) (i32.add (local 4) (local 6))))
                      (eq (i32 1) (i32.lt_u (local 1) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 8) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 5) (i32 2000))))
                     (post
  ...
  (type (;31;) (func (pre
                      (eq (i32 1) (i32.lt_u (local 0) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 32000000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 2000))))))
  (type (;32;) (func (post
                      (eq (i32 1) (i32.le_u (local 1) (i32.add (local 0) (i32 31999992))))
                      (eq (local 2) (old_local 2))
                      (eq (local 0) (old_local 0)))))
  (type (;33;) (func (post
                      (eq (local 2) (old_local 2))
                      (eq (i32 1) (i32.gt_u (local 2) (i32 0)))
                      (eq (local 0) (old_local 0))
                      (eq (i32 1) (i32.le_u (local 5) (i32.add (local 0) (i32 31984000))))
                      (eq (i32 1) (i32.le_u (local 1) (i32.add (local 0) (i32 31999992)))))))
  (type (;34;) (func (post
                      (eq (local 1) (i32.add (local 0) (i32.add (i32.mul (local 2) (i32 16000)) (i32.shl (local 2) (i32 3)))))
                      (eq (local 2) (old_local 2))
                      (eq (local 0) (old_local 0)))))
  (type (;35;) (func (post
                      (eq (local 1) (i32 0))
  ...
  (type (;36;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 1) (local 2))))
                     (post
                      (eq (i32 1) (i32.le_u (local 5) (i32.add (local 0) (i32 31984000)))) ;; 16000*1999
                      (eq (i32 1) (i32.le_u (local 6) (i32.add (local 0) (i32 31999992)))) ;; 16000*1999 + 1999*8
                      (eq (local 2) (old_local 2))
                      (eq (local 0) (old_local 0)))))
  (type (;37;) (func (post
  ...
  (type (;38;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (local 2) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 1) (local 2)))
                      (eq (i32 1) (i32.lt_u (local 4) (local 1)))
                      (eq (local 5) (i32.add (local 0) (i32.mul (local 2) (i32 16000))))
                      (eq (local 6) (i32.add (local 5) (i32.shl (local 1) (i32 3)))))
                     (post
                      (eq (local 7) (old_local 7))
                      (eq (local 6) (old_local 6))
                      (eq (local 5) (old_local 5))
  ...
  (type (;39;) (func (pre
                      ...
                      (eq (i32 1) (i32.lt_u (i32.add (local 0) (i32 32000000)) (i32 33554432)))
                      (eq (i32 1) (i32.lt_u (local 2) (i32 2000)))
                      (eq (i32 1) (i32.lt_u (local 4) (local 2)))
                      (eq (i32 1) (i32.le_u (local 5) (i32.add (local 0) (i32 31984000))))
                      (eq (i32 1) (i32.le_u (local 1) (i32.add (local 0) (i32 31999992)))))
                     (post
                      (eq (local 1) (old_local 1))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    call $dlfree
    i32.const 0)
  (func $init_array (type 3) (param i32)
    ...
    local.get 2
    call $dlfree)
  (func $kernel_cholesky (type 3) (param i32)
    (local i32 i32 f64 i32 i32 i32 i32 i32 f64)
    ;; Hand inserted check that sizes are legal
    block (type 30)
      local.get 0
      i32.const 32000000
    ...
    loop (type 31) ;; label = @1
      i32.const 0
      local.set 1
      block (type 32) ;; label = @2
        block (type 33) ;; label = @3
          block (type 34) ;; label = @4
            local.get 2
            i32.eqz
            if (type 35) ;; label = @5
              local.get 1
  ...
  (data (;0;) (i32.const 1024) "[PolyBench] posix_memalign: cannot allocate memory\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00begin dump: %s\00nan\00inf\00NAN\00INF\00A\00.\00(null)\00%0.2lf \00\0aend   dump: %s\0a\00==BEGIN DUMP_ARRAYS==\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00\b0\06")
